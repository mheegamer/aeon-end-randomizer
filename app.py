# ==============================================================================
# Aeon's End Randomizer - Final Corrected Version for Deployment
# ==============================================================================
...
def load_data_from_sheet(sheet_name):
    try:
        ...
        # Fallback for local run if secrets are not available
        try:
            ...
            st.sidebar.error("เกิดข้อผิดพลาดในการโหลดชีต")
            st.sidebar.error("โปรดตรวจสอบไฟล์ credentials.json หรือการตั้งค่า Secrets")
